...
<head>
	...
	<title>404 error - Cerf'Lock Holmes</title>
...
<body>
	...
	<header>
		<nav>
			...
			<a href="/fr/404" onclick="changeLanguage()" class="quick-access" title="En Français dans le texte...!">
	...
	<main style="text-align:center;">
		<h1>404 Error</h1>
		<h3>Sorry, but MoriArty has stolen this page...</h3>
		<br>
		<img style="max-width: 100%;" src="/data/moriarty.png" alt="Logo de la liste MoriArty" />
	</main>
