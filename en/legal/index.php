...
<head>
	...
	<link rel="alternate" hreflang="fr" href="/fr/legal" />
	<link rel="canonical" href="https://www.cerflock.fr/fr/legal" />
...
<body>
	...
	<header>
		<nav>
			...
			<a href="/fr/legal" onclick="changeLanguage()" class="quick-access" title="En Français dans le texte...!">
