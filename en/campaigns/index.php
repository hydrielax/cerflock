...
<body>
	...
	<header>
		<nav>
			...
			<a href="/fr/campaigns" onclick="changeLanguage()" class="quick-access" title="En Français dans le texte...!">
	...
	<main>
		<h1>Campaigns</h1>
		<p>Here is the list of cancelled events:</p>
		<ul>
			<li>The meal in the MDE (but we have all planned, you know!)</li>
			<li>The BDE tonus (we asked to night clubs but they said no, that's strange...)</li>
		</ul>
	</main>
