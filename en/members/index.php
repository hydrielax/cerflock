...
<head>
	...
	<link rel="alternate" hreflang="en" href="/en/members" />
	<link rel="alternate" hreflang="fr" href="/fr/members" />
	<link rel="canonical" href="https://www.cerflock.fr/fr/members" />
	...
	<script type="text/javascript">
		checkLanguage("en", "members");
	</script>
	<?php echo '<script type="text/javascript" src="/js/membres.js?' . filemtime($_SERVER['DOCUMENT_ROOT'].'/js/membres.js') .'"></script>' ?>
</head>
...
<body>
	...
	<header>
		<nav>
			...
			<a href="/fr/members" onclick="changeLanguage()" class="quick-access" title="En Français dans le texte...!">
	...
	<main>
		<h1>Members</h1>
		<p>Discover the greatest inspectors of Centrale!</p>
		<br>
		<div class="jeu">
			<script type="text/javascript">
				generer_cartes(1);
