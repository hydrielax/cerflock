...
<head>
	...
	<meta property="og:image" content="https://www.cerflock.herokuapp.fr/data/photos/groupe-fun.jpg">
	...
	<main style="padding-top:1rem;">
		<div style="display:flex;flex-wrap: wrap;">
			<div style="flex-basis: 200px;flex-grow: 1;margin-right: 2rem;">
				...
				<p>Candidats au BDE de Centrale Nantes pour l'année 2021, nous sommes déterminés à vous faire vibrer durant ces campagnes !</p>
...
">
			...
			<a href="/fr/campaigns#soiree" class="carte">
				<img src="/data/photos/soiree_bde.jpg" alt="Les grandes soirées de Cerf'Lock !">
				<h2>La Soirée BDE</h2>
			</a>
		...
		<p>Parce qu'on n'est jamais à court d'idées, tu peux encore découvrir tous ces bonus préparés rien que pour toi !</p>
		<br>
		<div class="jeu">
			...
			<a href="https://www.facebook.com/cerflock" target="_blank" class="carte">
				<div class="image">
